...
$elements = [
	...
	'PFH_Element_Product_Tabs' => [ 'class-pfh-element-product-tabs.php', 'pfh-product-tabs.css' ],
	'PFH_Element_Product_Related' => [ 'class-pfh-element-product-related.php', 'pfh-products.css' ],
	'PFH_Element_Product_Usp' => [ 'class-pfh-element-product-usp.php', 'pfh-product-usp.css' ],
