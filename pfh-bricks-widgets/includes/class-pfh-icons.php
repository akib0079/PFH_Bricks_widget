...
class PFH_Widgets_Icons {
	...
	private static function all() {
		...
		return [
			...
			'phone'     => '<path d="M6.5 3.5h3l1.5 3.8-2 1.4a12 12 0 0 0 5.3 5.3l1.4-2 3.8 1.5v3a2 2 0 0 1-2.2 2A16.5 16.5 0 0 1 4.5 5.7a2 2 0 0 1 2-2.2Z" ' . $stroke . '/>',
			...
			'review'    => '<path d="M5.5 4.5h13a2 2 0 0 1 2 2v8.5a2 2 0 0 1-2 2H11l-4.2 3.3a.5.5 0 0 1-.8-.4V17h-.5a2 2 0 0 1-2-2V6.5a2 2 0 0 1 2-2Z" ' . $stroke . '/>' . '<path d="m12 7.6.95 1.93 2.13.31-1.54 1.5.36 2.12L12 12.46l-1.9 1 .36-2.12-1.54-1.5 2.13-.31L12 7.6Z" ' . $stroke . '/>',
			'medal'     => '<circle cx="12" cy="14.5" r="6" ' . $stroke . '/>' . '<path d="m12 11.6.9 1.83 2.02.3-1.46 1.42.34 2.01L12 16.2l-1.8.96.34-2.01-1.46-1.42 2.02-.3L12 11.6Z" ' . $stroke . '/>' . '<path d="M8.6 9.6 6.5 3.5h3.8L12 8.2l1.7-4.7h3.8l-2.1 6.1" ' . $stroke . '/>',
			...
			'box-check' => '<path d="M22.2031 7.58337V13M2.70312 7.58337C2.70312 10.9032 2.70312 18.1721 2.70312 18.5915C2.70312 20.0892 4.8109 20.9796 9.02646 22.7603C10.72 23.4757 11.5668 23.8334 12.4531 23.8334V12.3011" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M8.47287 10.499L5.30823 8.96763C3.57149 8.12723 2.70312 7.70704 2.70312 7.04163C2.70312 6.37621 3.57149 5.95602 5.30823 5.11562L8.47287 3.5843C10.426 2.63919 11.4026 2.16663 12.4531 2.16663C13.5036 2.16663 14.4803 2.63918 16.4334 3.5843L19.598 5.11562C21.3347 5.95602 22.2031 6.37621 22.2031 7.04163C22.2031 7.70704 21.3347 8.12723 19.598 8.96763L16.4334 10.499C14.4803 11.4441 13.5036 11.9166 12.4531 11.9166C11.4026 11.9166 10.426 11.4441 8.47287 10.499Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M5.95312 13L8.11979 14.0833" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M17.8685 4.33337L7.03516 9.75004" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M15.7031 20.5833C15.7031 20.5833 16.651 20.5833 17.599 22.75C17.599 22.75 20.61 17.3333 23.2865 16.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
