...
define( 'PFH_WIDGETS_VERSION', '1.49.0' );
...
require_once PFH_WIDGETS_DIR . 'includes/class-pfh-policy.php';
require_once PFH_WIDGETS_DIR . 'includes/class-pfh-collection.php';
require_once PFH_WIDGETS_DIR . 'includes/class-pfh-recent.php';
require_once PFH_WIDGETS_DIR . 'includes/class-pfh-checkout-labels.php';
require_once PFH_WIDGETS_DIR . 'includes/class-pfh-cart-page.php';
require_once PFH_WIDGETS_DIR . 'includes/class-pfh-blog.php';
require_once PFH_WIDGETS_DIR . 'includes/class-pfh-post-body.php';
